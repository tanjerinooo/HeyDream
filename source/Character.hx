	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'parents-christmas':
				...
				playAnim('idle');
			case 'dream':
					tex = Paths.getSparrowAtlas('dream_assets','shared',true);
					frames = tex;
					animation.addByPrefix('idle', 'dream_idle', 24);
					animation.addByPrefix('singUP', 'dream_up', 24);
					animation.addByPrefix('singRIGHT', 'dream_right', 24);
					animation.addByPrefix('singDOWN', 'dream_down', 24);
					animation.addByPrefix('singLEFT', 'dream_left', 24);
	
					loadOffsetFile('dream');
